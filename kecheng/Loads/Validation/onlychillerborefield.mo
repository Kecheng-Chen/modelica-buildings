...
"Partial validation of the ETS model with heat recovery chiller and optional borefield"
  ...
  Buildings.Fluid.Sources.Boundary_pT heaWat(
...
equation
  ...
  connect(loa.y[1], loaCooNor.u) annotation (Line(points={{-309,160},{376,160},
          {376,132},{344,132},{344,60},{272,60}}, color={0,0,127}));
