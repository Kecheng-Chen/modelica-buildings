...
equation
  ...
  connect(terUniHea.mReqHeaWat_flow,disFloHea.mReq_flow[1])
    annotation (Line(points={{90.8333,-15.3333},{98,-15.3333},{98,-64},{119,-64}},   color={0,0,127}));
  ...
  connect(loa.y[2], mulQReqHea_flow.u) annotation (Line(points={{-259,0},{166,0},
          {166,40},{270,40}}, color={0,0,127}));
